...
O [CI 34908987436](https://github.com/manoelcalixto/webtop-arch-kde-workstation/actions/runs/34908987436) aprovou o conjunto completo no head `2cd45e23382864627e651fccc46d605f501234d5`. O [PR #16](https://github.com/manoelcalixto/webtop-arch-kde-workstation/pull/16) foi integrado em `addf745ab22129e1b175ad5f86a2461921f23770` em 2026-09-14, encerrando #3 e #4. O teste das APIs Windows permanece coberto pela execução local; no runner Linux ele é explicitamente pulado. A árvore do merge é igual à do head aprovado.

O [CI de main 34910438515](https://github.com/manoelcalixto/webtop-arch-kde-workstation/actions/runs/34910438515) também terminou com sucesso: job `104196498352`, 17 min 7 s, acompanhado até exit code 0. Isso confirma a execução após o merge, além do CI do PR.
