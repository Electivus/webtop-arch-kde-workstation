...
A PR #19 foi integrada em `2026-09-15T07:05:51Z`, pelo merge `e8e2ae6d51c47c21f76096f175ae8b32237a09e5`, e a issue #8 foi fechada no segundo seguinte. A árvore do merge, `bafa5ad2dba32bc8a1626214616050ceddd32d3c`, é idêntica à do head verificado `0caa92e27cf1ac94c77d0d4c6ed3bcd9a060c0f7`.

O [CI da PR](https://github.com/manoelcalixto/webtop-arch-kde-workstation/actions/runs/34936721917), job `104276131853`, passou em 38 min 14 s. O preparo elevou o espaço livre de 14 para 36 GiB, e os treze casos de backup passaram em 807,120 s, incluindo retenção, recuperação Salesforce, os três achados publicados e o diagnóstico limitado. Todos os demais passos obrigatórios também passaram. O êxito do cenário de parada confirma este build no runner; a sonda local continua sem estabelecer a causa temporal da falha antiga.

Os três threads do bot foram respondidos com as correções e provas correspondentes e resolvidos. Uma leitura imediatamente anterior ao merge confirmou zero itens e zero threads pendentes, checks aprovados e estado `CLEAN`. O [CI de main](https://github.com/manoelcalixto/webtop-arch-kde-workstation/actions/runs/34939996456), no SHA do merge, também passou: job `104286245118`, de `2026-09-15T07:05:56Z` a `07:42:22Z`, duração de 36 min 26 s. A leitura final confirmou `completed/success` e o mesmo SHA `e8e2ae6d51c47c21f76096f175ae8b32237a09e5`.
